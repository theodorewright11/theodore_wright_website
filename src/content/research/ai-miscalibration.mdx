...
description: 'A framework for why people hold inaccurate views about AI, and why giving them better information does not fix it.'
date: 2026-04-01
status: published
...
posterUrl: '/papers/AI_Miscalibration_Poster.pdf'
authors:
  - name: 'Teddy Wright'
