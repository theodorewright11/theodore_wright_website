---
title: 'Topology'
description: 'Dependency graph of the lit review — typed nodes (assumption, method, empirical, logical, mechanism, synthesis, open, distortion), typed edges, six crux nodes, weakest links, and four variant views (vulnerability, flow, minimal claim set, politicization).'
date: 2026-04-28
status: in-progress
refinementPass: 0
---
...
| **A4** | 4 | Heritability is a population statistic, not an individual one (definitional) | ✓ |
...
| ID | Wt | Claim |
|---|---|---|
| **L1** | 5 | Heritability is a population variance ratio; it does not partition individual phenotypes |
...
| **L4** | 5 | Within-population heritability provides no information about between-population mean differences (Lewontin) |
...
## 8. Stage_outputs convention reference
