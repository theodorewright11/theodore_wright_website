        ...
        {open && (
          ...
          >
            ...
            <div className="text-[12px] text-slate-500 leading-snug">
              ...
              the other dashboards, with Drive API enabled). Then restart the dev server.
            </div>
          </div>
        )}
      </div>
      ...
      {open && (
        ...
        >
          ...
          <div className="px-3.5 py-2.5 text-[12px] text-slate-500 border-b border-slate-100">
            {runCount} run{runCount === 1 ? '' : 's'} synced · <SyncLabel status={syncStatus} />
            {lastError && (
          ...
          >
            ...
            <div className="text-[11px] text-slate-500 leading-snug">
              Push everything to Drive immediately (skips the auto-save wait).
            </div>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <div className="text-[11px] text-slate-500 leading-snug">
              Re-fetch state from Drive (use after rating on another device).
            </div>
          </button>
          <button
            type="button"
