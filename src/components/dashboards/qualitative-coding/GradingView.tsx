...
type ThemeSortKey = 'name' | 'count' | 'grounding' | 'usefulness' | 'independence' | 'interpretationLevel' | 'prevalence' | 'aiPriorNovelty' | 'analyticalNovelty';
...
function ThemesTable({
  ...
  const ratingHeaders: { key: ThemeSortKey; short: string; long: string }[] = [
    ...
    { key: 'usefulness', short: 'Research question fit', long: 'Research question fit' },
