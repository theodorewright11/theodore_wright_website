...
export default function AITransitionGraph() {
  ...
  const variantBlurb: Record<Variant, string> = {
    ...
    leverage: 'Decision-leverage view. Saturated = high individual leverage (the seven strategic recommendations — direct decisions you can make). Mid-tone = medium (mechanisms G4 / G7 / G10, frameworks F1–F3, and the finding/forecast/interpretation discipline L1 — mental models that make the strategic recommendations actually applicable to your life). Faded = structural / outside individual control. The high+medium cluster is the entire decision-relevant core of this topology.',
  };
